/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4a77a64e59fa4cad60a530366a6ea6e)
// Runtime types generated with workerd@1.20251109.0 2025-11-09 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Sandbox" | "CompilerDO";
	}
	interface Env {
		Sandbox: DurableObjectNamespace<import("./worker/index").Sandbox>;
		Compiler: DurableObjectNamespace<import("./worker/index").CompilerDO>;
		LOADER: WorkerLoader;
	}
}
