/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .dev.vars.example` (hash: dc4433116bcace73bc754de887da6e4d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		BROKER_AWS_ACCESS_KEY_ID: string;
		BROKER_AWS_SECRET_ACCESS_KEY: string;
		AWS_ROLE_ARN: string;
