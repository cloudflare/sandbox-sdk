/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 93a2fda6674f0904ebe547b35881aba1)
// Runtime types generated with workerd@1.20260617.1 2026-04-22 nodejs_compat
interface __BaseEnv_Env {
	DEVIN_CHECKPOINTS: R2Bucket;
	DEVIN_OUTPOST_ID: "";
	...
	DevinWorker: DurableObjectNamespace<import("./src/index").DevinWorker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DevinWorker";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEVIN_OUTPOST_ID" | "DEVIN_API_URL" | "WORKER_ID_PREFIX" | "DEVIN_RECONCILE_INTERVAL_MS" | "DEVIN_API_TOKEN">> {}
}
