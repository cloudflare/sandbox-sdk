...
HTTP bridge between the [OpenAI Agents SDK](https://github.com/OpenAI-Early-Access/openai-agents-python-preview) and the [Cloudflare Sandbox](https://developers.cloudflare.com/sandbox/). Translates the SDK's sandbox session operations into calls against the `@cloudflare/sandbox` Durable Object API.
