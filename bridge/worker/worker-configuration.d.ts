/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .dev.vars.example` (hash: 3720c64282d9b98627354393e7299487)
// Runtime types generated with workerd@1.20260415.1 2025-05-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "WarmPool";
	}
	interface Env {
		...
		SANDBOX_EXPERIMENTAL_RPC: string;
		Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
		WarmPool: DurableObjectNamespace<import("./src/index").WarmPool>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SANDBOX_TRANSPORT" | "WARM_POOL_TARGET" | "WARM_POOL_REFRESH_INTERVAL" | "SANDBOX_API_KEY" | "SANDBOX_EXPERIMENTAL_RPC">> {}
}
