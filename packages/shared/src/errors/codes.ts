...
export const ErrorCode = {
  ...
  // Process Errors (400)
  INVALID_PROCESS_CWD: 'INVALID_PROCESS_CWD',
  INVALID_PROCESS_ENVIRONMENT: 'INVALID_PROCESS_ENVIRONMENT',
  INVALID_PROCESS_CURSOR: 'INVALID_PROCESS_CURSOR',
  INVALID_TERMINAL_CWD: 'INVALID_TERMINAL_CWD',
  INVALID_TERMINAL_CURSOR: 'INVALID_TERMINAL_CURSOR',

  // Process Errors (408/409/499)
  STALE_PROCESS_HANDLE: 'STALE_PROCESS_HANDLE',
  STALE_TERMINAL_HANDLE: 'STALE_TERMINAL_HANDLE',
  ...
  TERMINAL_CONTROL_ERROR: 'TERMINAL_CONTROL_ERROR',
  ...
  PROCESS_EXITED_BEFORE_LOG: 'PROCESS_EXITED_BEFORE_LOG',
  ...
  CONTROL_PROTOCOL_INCOMPATIBLE: 'CONTROL_PROTOCOL_INCOMPATIBLE',
