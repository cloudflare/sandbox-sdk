  ...
  components: {
    ...
    schemas: {
      ...
      MountBucketCredentials: {
        ...
        properties: {
          accessKeyId: { type: 'string', description: 'S3-compatible access key ID.' },
          secretAccessKey: { type: 'string', description: 'S3-compatible secret access key.' }
        }
      },
    ...
    responses: {
      ...
      InvalidRequest: {
        ...
        content: {
          'application/json': {
            schema: { $ref: '#/components/schemas/ErrorResponse' },
            example: { error: 'argv must be a non-empty array', code: 'invalid_request' }
          }
        }
      }
    }
  ...
  paths: {
        ...
        responses: {
          ...
          '502': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/ErrorResponse' },
                example: { error: 'exec failed: connection reset', code: 'exec_transport_error' }
              }
            }
          }
        }
        ...
        responses: {
          ...
          '502': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/ErrorResponse' },
                example: { error: 'read failed: connection reset', code: 'exec_transport_error' }
              }
            }
          }
        }
    ...
    '/v1/sandbox/{id}/pty': {
      get: {
        ...
        responses: {
          '101': {
            description: 'WebSocket upgrade successful. Binary and text frames flow bidirectionally as described above.'
          },
          '400': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/ErrorResponse' },
                example: { error: 'WebSocket upgrade required', code: 'invalid_request' }
              }
            }
          },
          '401': { $ref: '#/components/responses/Unauthorized' },
          '502': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/ErrorResponse' },
                example: { error: 'terminal failed: connection reset', code: 'exec_transport_error' }
              }
            }
          }
        }
        ...
        responses: {
          ...
          '502': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/ErrorResponse' },
                example: { error: 'tar failed (exit 1): ...', code: 'workspace_archive_read_error' }
              }
            }
          }
        }
        ...
        responses: {
          ...
          '502': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/ErrorResponse' },
                example: { error: 'mount failed: Mount path already in use', code: 'mount_error' }
              }
            }
          }
        }
        ...
        responses: {
          ...
          '502': {
            ...
            content: {
              'application/json': {
                schema: { $ref: '#/components/schemas/ErrorResponse' },
                example: { error: 'unmount failed: No active mount found', code: 'unmount_error' }
              }
            }
          }
        }
