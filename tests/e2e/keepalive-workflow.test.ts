 ...
 *
 * Note: Testing keepAlive persistence across DO hibernation is not reliable in E2E tests
 * because we cannot force DO hibernation. The persistence logic is tested in unit tests
 * (packages/sandbox/tests/sandbox.test.ts) where we can mock storage behavior.
 */
