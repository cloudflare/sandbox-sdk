/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: a045c998320768ac20bfc58c0db27d8c)
// Runtime types generated with workerd@1.20260617.1 2026-09-07 experimental,nodejs_compat
interface __BaseEnv_Env {
	EXECUTOR_KEEP_ALIVE_SECONDS: "30";
	EXECUTOR_PREWARM_ENABLED: "true";
	EXECUTOR_SNAPSHOTS_ENABLED: "false";
	OPENAI_EXECUTOR_API_KEY: string;
	EXECUTOR_CLIENT_SECRET: string;
	OPENAI_API_KEY: string;
	OPENAI_AGENT_ID: string;
	OPENAI_WEBHOOK_SECRET: string;
	EXECUTORS: DurableObjectNamespace<import("./src/index").ExecutorEnvironment>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ExecutorEnvironment";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EXECUTOR_KEEP_ALIVE_SECONDS" | "EXECUTOR_PREWARM_ENABLED" | "EXECUTOR_SNAPSHOTS_ENABLED" | "OPENAI_EXECUTOR_API_KEY" | "EXECUTOR_CLIENT_SECRET" | "OPENAI_API_KEY" | "OPENAI_AGENT_ID" | "OPENAI_WEBHOOK_SECRET">> {}
}
